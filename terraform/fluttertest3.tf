module "fluttertest3" {
  ...
  control_tower_parameters = {
    AccountEmail              = "shahpay+fluttertest3@amazon.com"
    AccountName               = "dtpl-fluttertest3-customer-profile-dev"
    ManagedOrganizationalUnit = "Sandbox"
    SSOUserEmail              = "shahpay+fluttertest3@amazon.com"
    SSOUserFirstName          = "Control"
